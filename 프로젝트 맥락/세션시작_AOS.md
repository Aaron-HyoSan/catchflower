...
실호출로 돈다**(누적 **23건**/500건·일 · 진행.md (43)(49)). 지도 타일·핀·사용자 사진까지 실기 확인됐다.
...
⏸ **사람이 할 일: 유튜브 업로드.** 절차·설명란 문구는 `제출물/플레이영상_콘티.md` 5-2절.
링크를 받으면 **`docs/index.html` · `제출물/게임_소개.md`(→PDF 재생성) · `README.md` 세 곳**에 넣는다.
⚠️ 콘티 5-2절 설명란이 `Galaxy A25 실기기에서 실제 꽃을 촬영해 녹화한 것입니다`로 적혀
있는데 **이 영상은 에뮬레이터다.** 업로드 전에 그 줄을 고쳐야 한다.
