...
화면 22개 중 21개가 돈다**(2026-08-16 기준 · **25차** · 커밋 76개).
...
🔴 **`main`이 `origin/main`보다 29개 앞서 있다(아직 push 안 함).**
...
| 4 | `프로젝트 맥락/진행.md` **맨 끝부터 거꾸로** | 최근 결정이 뒤에 있다. **(79)(80)이 지금 맥락**이고((80)에 오너 답 6건이 한 번에 닫힌 표가 있다) (19)는 iOS인데 AOS도 물린다 |
